...
# endpoint = "http://localhost:8501/AudioDetect/saved_models:predict"
...
async def predict(
    ...
    # Gender Detection
    json_file = open('../api/saved_models/model_json_gender.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    loaded_model = model_from_json(loaded_model_json)

    # load weights into new model
    loaded_model.load_weights("../api/saved_models/gender_Model.h5")
    ...
    # Emotion Detection
    json_file = open('../api/saved_models/model_json_emotion.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    loaded_model = model_from_json(loaded_model_json)

    # load weights into new model
    loaded_model.load_weights("../api/saved_models/Emotion_Model.h5")
    print("Loaded model from disk")
    ...
    # Age Detection
    json_file = open('../api/saved_models/model_json_age.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    loaded_model = model_from_json(loaded_model_json)

    # load weights into new model
    loaded_model.load_weights("../api/saved_models/Age_Model.h5")
    print("Loaded model from disk")
